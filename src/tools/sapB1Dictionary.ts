...
export const SAP_B1_TABLES: Record<string, { description: string; category: string; relatedTables?: string[] }> = {
  // === MAESTROS ===
...
export const SAP_B1_COMMON_FIELDS: Record<string, string> = {
...
export const SAP_B1_OBJECT_TYPES: Record<string, string> = {
...
export const SAP_B1_RELATIONSHIPS = [
...
export function getTableInfo(tableName: string): { description: string; category: string; relatedTables?: string[] } | null {
  return SAP_B1_TABLES[tableName.toUpperCase()] || null;
}

// Función para obtener descripción de un campo
export function getFieldDescription(fieldName: string): string | null {
  return SAP_B1_COMMON_FIELDS[fieldName] || null;
}

// Función para obtener el tipo de objeto
export function getObjectTypeDescription(objType: string): string | null {
  return SAP_B1_OBJECT_TYPES[objType] || null;
}
